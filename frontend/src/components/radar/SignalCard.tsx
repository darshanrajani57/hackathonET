...
export function SignalCard({ signal, onChat }: { signal: Signal; onChat?: () => void }) {
  return (
    <article className="panel p-3">
      ...
      <div className="mt-3 flex gap-2">
        <NeonButton variant="ghost">View Filing</NeonButton>
        <NeonButton variant="ghost">Add to Watchlist</NeonButton>
        <NeonButton onClick={onChat}>Chat</NeonButton>
      </div>
    </article>
  );
}
